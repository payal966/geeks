...
public class Fourthcredential {

	
	 public WebDriver driver;
		
		@Test
		 public void Fourth_User_validpassword() {
			 ...
			 driver.findElement(By.xpath("//input[@id='email']")).sendKeys("https://auth.geeksforgeeks.org/user/demo_4");
		...
		@Test
		public void Fourth_invalidpassword() {
			driver.findElement(By.xpath("//input[@id=\"luser\"]")).sendKeys("https://auth.geeksforgeeks.org/user/demo_4");;
			driver.findElement(By.xpath("//input[@id=\"password\"]")).sendKeys("abcdeg");
			driver.findElement(By.xpath("//button[contains(text(),'Sign In')]")).click();
