...
public class User3 {
 ...
 public void TC_03_US3() {
	 ...
	 driver.findElement(By.xpath("//input[@id=\"luser\"]")).sendKeys("demo_3");
	...
	String actualUs1 = driver.findElement(By.xpath("//input[@id=\"luser\"]")).getText();
	 String expectedUs1 = "demo_3";                         //for valid range userhandle
 ...
 public void TC_O3_Us3() {
	 driver.findElement(By.xpath("//input[@id=\"luser\"]")).sendKeys("demo_3890");
	 driver.findElement(By.xpath("//input[@id=\"password\"]")).sendKeys("usER3pssw");
	 driver.findElement(By.xpath("//button[contains(text(),'Sign In')]")).click();
	String actualUs11 = driver.findElement(By.xpath("//input[@id=\"luser\"]")).getText();
	 String expectedUs11 = "demo_3" ;                    // for invalid  range userhandle      
